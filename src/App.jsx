...
function App() {
  ...
  let searchResults = appsList.filter((eachApp) =>
  ...
  let getSearchResults = (searchResults) => {
  ...
  let filteredApps = getSearchResults(searchResults);
  return (
    <>
        ...
        <div className="app-store">
          ...
          <ul className="apps-list">
            {filteredApps.map((eachApp) => (
              <AppItems appDetails={eachApp} key={eachApp.appId} />
            ))}
          </ul>
        </div>
      </div>
